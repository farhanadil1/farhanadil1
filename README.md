<!-- Profile README for @farhanadil1 -->
...
-  Skilled in both **MERN stack** and **Java Full Stack** development

-  Enthusiast in **UI/UX Design** with **Figma**
...
- [Weatheria](https://github.com/farhanadil1/Weatheria) – Real-time weather app



Explore more projects in my [GitHub Portfolio](https://github.com/farhanadil1?tab=repositories) or [personal portfolio site](https://farhanadil.netlify.app).
